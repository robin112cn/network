...
<!--<![endif]-->
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="cmsTemplateList.jsp"%>
					<!-- your code here end-->
				</div>
			</div>
			<!-- END CONTENT -->
		...
		<script src="${ctxResources}/pages/scripts/cms/cmsTemplate/cmsTemplateUI.js"></script>
		<script >
		function getPremission(data){
			var p = "<a class='btn default btn-xs generate blue' name='"+data+"' ><i class='fa fa-edit'></i> 生成静态页面</a>";
			p += "<a name='"+data+"' class='btn default preview btn-xs red'><i class='fa fa-trash-o'></i> 预览 </a>";
			return p;
		};
