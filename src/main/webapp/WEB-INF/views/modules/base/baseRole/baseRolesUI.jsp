...
<link href="${ctxResources}/global/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="${ctxResources}/global/plugins/zTree/css/metroStyle/metroStyle.css" />
...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<%@ include file="baseRolesList.jsp"%>
				<!-- your code here end-->
			</div>
		</div>
		<%@ include file="baseRolesEdit.jsp"%>
	...
	<script src="${ctxResources}/pages/scripts/base/baseRolesUI.js"></script>
