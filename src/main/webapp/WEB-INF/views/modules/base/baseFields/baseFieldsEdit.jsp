							...
							<input type="hidden" name="tag" id="tag" value="add">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<div class="input-icon right">
											<i class="fa"></i>
											<input type="text"  name="enFieldName" id="enName" placeholder="字段" class="form-control form-filter">
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="input-icon right">
											<i class="fa"></i>
										<input type="text"  name="fieldSort" placeholder="排序" class="form-control form-filter" onkeyup="value=value.replace(/[^\d]/g, '')">
										</div>
									</div>
								</div>
								<div class="form-group">
