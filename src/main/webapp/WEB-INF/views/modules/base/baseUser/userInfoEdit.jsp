						...
						<form class="form-horizontal" id="userForm" role="form">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="input-icon right">
										<i class="fa"></i>
										<input type="password" id="userPassWordAdd"   name="userPassWord" class="form-control"
											placeholder="用户密码">
								...
								<div class="form-group">
									...
									<div class="input-icon right">
										<i class="fa"></i>
										<input type="password" id=userPassWordRepeatAdd name="userPassWordRepeat" class="form-control"
											placeholder="确认密码">
									</div>
									</div>
								</div>
