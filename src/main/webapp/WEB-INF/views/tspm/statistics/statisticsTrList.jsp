...
<div class="page-bar">
	<ul class="page-breadcrumb">
		<li><i class="fa fa-home"></i> TR管理 <i class="fa fa-angle-right"></i></li>
		<li>TR信息统计</li>
	</ul>
</div>
<div class="portlet box green-haze">
	...
	<!-- <div class="portlet-title">
		<div class="caption">
			<i class="fa fa-globe"></i>Token信息统计
		</div>
	</div> -->
	<!-- 标题 结束-->
	<!-- 查询条件开始 -->
			...
			<div class="col-md-12">
				<div class="portlet light">
					<div class="caption">
						...
						<span class="caption-subject">TR信息统计</span>
					...
					<div class="portlet-body form">
						...
						<div class="form-body clearfix">
							...
							<div class="btn-set pull-right col-md-2">
								...
								<shiro:hasPermission name="statisticsTr:search">
