...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="statisticsTokenList.jsp"%>
					<!-- your code here end-->
				</div>
			</div>
			<!-- END CONTENT -->
		...
		<script src="${ctxResources}/global/plugins/bootstrap-datepicker/js/locales/bootstrap-datepicker.zh-CN.js"></script>
		...
		<script src="${ctxResources}/pages/scripts/tspm/statisticsTokenUI.js"></script>
		<script >
