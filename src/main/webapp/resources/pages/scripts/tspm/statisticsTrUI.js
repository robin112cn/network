...
var statisticsTrUI = function() {
		...
		grid.init({
					...
					dataTable : {
						...
						"columnDefs" : [{
									...
									'name' : 'TR_CREATE_SUM_NUM',
									'orderable' : true,
									'width' : "40%",
									'targets' : [1]
								}, {
									'name' : 'TR_DESTORY_SUM_NUM',
									'orderable' : true,
									'width' : "40%",
									'targets' : [2]
								}],
						'columns' : [{
									...
									'title' : 'TR注册次数',
									'field' : 'trCreateSumNum',
									'fieldRender' : 'format'
									
								}, {
									'title' : 'TR销毁次数',
									'field' : 'trDestorySumNum',
									'fieldRender' : 'format'
								}],
						'order' : [[0, "asc"]]
					}
	...
	var activeBootstrapControls = function() {
		...
		$("#export").click(function() {
			window.location.href = ctx + '/statisticsTr/export?period=' + $("#periodSearch").val() + 
