    	 ...
    	 $.each(data, function(key, obj) {
    		 ...
    		 $.each(fields, function(k, v) {
    			 if(v.wrapper){
				     ...
				     if(v.fieldRender){
				     	 if(v.custom){
							var customVal = obj[v.custom];
							htm = eval(v.fieldRender+"('"+htm+"','"+customVal+"')");
				     	 }else{
    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                loadingMessage: '加载中...',
                dataTable: {
                    "dom": "<'row'<'col-md-4 col-sm-12'<'table-group-actions pull-right'>>r><'table-scrollable't><'row'<'col-md-4 col-sm-12' l i><'col-md-8 col-sm-12'p>>", // datatable layout
